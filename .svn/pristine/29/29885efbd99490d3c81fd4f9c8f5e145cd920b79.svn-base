...
public class SftpFault_Type extends com.sap.aii.proxy.xiruntime.core.AbstractType implements java.io.Serializable {
    ...
    static {
        com.sap.aii.proxy.xiruntime.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.xiruntime.core.XsdlConstants.XSDL_COMPLEX_TYPE, "urn:newsint.co.uk:Common:Proxy:SFTP", "SftpFault", 1, 0, uk.co.newsint.sap.pi.proxy.sftp.receiver.SftpFault_Type.class, com.sap.aii.proxy.xiruntime.core.FactoryConstants.CONNECTION_TYPE_XML, null, 0, 0, 0, null);
        staticDescriptor = descriptor;
        descriptorSetElementProperties(descriptor, 0, "standard", null, null, "unqualified", "urn:newsint.co.uk:Common:Proxy:SFTP:ExchangeFaultData", "urn:newsint.co.uk:Common:Proxy:SFTP", false, 1, 1, false, null, "standard", uk.co.newsint.sap.pi.proxy.sftp.receiver.ExchangeFaultData_Type.class, new uk.co.newsint.sap.pi.proxy.sftp.receiver.ExchangeFaultData_Type(), new java.lang.String[][]{}, null, 0, 0, 0, -1, -1, -1, -1, 0, null);
    }
    ...
    public void setStandard(uk.co.newsint.sap.pi.proxy.sftp.receiver.ExchangeFaultData_Type standard) {
        baseTypeData().setElementValue(0, standard);
    }

    public uk.co.newsint.sap.pi.proxy.sftp.receiver.ExchangeFaultData_Type getStandard() {
        return (uk.co.newsint.sap.pi.proxy.sftp.receiver.ExchangeFaultData_Type)baseTypeData().getElementValue(0);
    }
