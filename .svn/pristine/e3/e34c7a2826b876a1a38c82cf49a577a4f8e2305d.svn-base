...
/* A SelectableTextInputPlus is a Text Input Plus field whose text can always be selected, even if 
...
*/
	public class SelectableTextInputPlus extends TextInputPlus
	{
		public function SelectableTextInputPlus()
		{
			super();
		}
