...
public class ExchangeFaultData_Type extends com.sap.aii.proxy.xiruntime.core.AbstractType implements java.io.Serializable {
    ...
    static {
        ...
        descriptorSetElementProperties(descriptor, 2, "faultDetail", null, null, "unqualified", "urn:newsint.co.uk:Common:Proxy:SFTP:ExchangeLogData", "urn:newsint.co.uk:Common:Proxy:SFTP", false, 0, -1, false, null, "faultDetail", FaultDetail_List.class, new ExchangeLogData_Type(), new java.lang.String[][]{}, null, 0, 0, 0, -1, -1, -1, -1, 0, null);
    }
    ...
    public ExchangeLogData_Type[] getFaultDetail() {
        FaultDetail_List i$ = (FaultDetail_List)baseTypeData().getElementValue(2);
        if ( i$ == null){return null;}
        return  i$.toArrayFaultDetail();
    }

    public void setFaultDetail(ExchangeLogData_Type[] faultDetail) {
    ...
    public ExchangeFaultData_Type.MetaData metadataExchangeFaultData_Type() {
        return metadata;
    }
    ...
    public static class FaultDetail_List extends com.sap.aii.proxy.xiruntime.core.AbstractList implements java.util.List, java.io.Serializable {
        ...
        public ExchangeLogData_Type removeFaultDetail(int index) {
            return (ExchangeLogData_Type)baseList().remove(index);
        }
    
        public ExchangeLogData_Type[] toArrayFaultDetail() {
            return (ExchangeLogData_Type[])baseList().toArray(new ExchangeLogData_Type[] {});
        }
        ...
        public ExchangeLogData_Type setFaultDetail(int index, ExchangeLogData_Type item) {
            return (ExchangeLogData_Type)baseList().set(index, item);
        }
    
        public boolean containsFaultDetail(ExchangeLogData_Type item) {
        ...
        public void addFaultDetail(int index, ExchangeLogData_Type item) {
            baseList().add(index, item);
        }
    
        public int indexOfFaultDetail(ExchangeLogData_Type item) {
        ...
        public int lastIndexOfFaultDetail(ExchangeLogData_Type item) {
            return baseList().lastIndexOf(item);
        }
    
        public void addFaultDetail(ExchangeLogData_Type item) {
            baseList().add(item);
        }
        ...
        public ExchangeLogData_Type getFaultDetail(int index) {
            return (ExchangeLogData_Type)baseList().get(index);
        }
    
        public boolean removeFaultDetail(ExchangeLogData_Type item) {
