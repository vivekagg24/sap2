          ...
          private function getTableTab(int:int):XMLList {
            ...
            private function getTabsToDisplay():void {
            	...
            	if (tab_to_display == -1) 
            	{
            		...
            		if (md_flag == true)
            		{
            			tabSelection.selectedIndex = c_default_md_tab;
            			tabSelection.getChildAt(c_default_md_tab).visible = true;
            			tabSelection.getTabAt(c_default_md_tab).visible = true;
            		}
            		else
            		{
            			tabSelection.selectedIndex = c_default_me_tab;
            			tabSelection.getChildAt(c_default_me_tab).visible = true;
            			tabSelection.getTabAt(c_default_me_tab).visible = true;
            		}
            	}
            	else
            	{
