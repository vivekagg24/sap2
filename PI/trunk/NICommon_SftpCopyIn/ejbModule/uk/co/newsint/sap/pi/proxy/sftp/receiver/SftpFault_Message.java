...
public class SftpFault_Message extends com.sap.aii.proxy.xiruntime.core.AbstractType implements java.io.Serializable {
    ...
    private  static final com.sap.aii.proxy.xiruntime.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.xiruntime.core.GenerationInfo("3.0", 1326281542755L) ;

    private  SftpFault_Message.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.xiruntime.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.xiruntime.core.XsdlConstants.WSDL_MESSAGE, "urn:newsint.co.uk:Common:Proxy:SFTP", "SftpFault", 1, 0, SftpFault_Message.class, com.sap.aii.proxy.xiruntime.core.FactoryConstants.CONNECTION_TYPE_XML, null, -1, 0, 0, null);
        staticDescriptor = descriptor;
        descriptorSetElementProperties(descriptor, 0, "SftpFault", null, null, "qualified", "urn:newsint.co.uk:Common:Proxy:SFTP:SftpFault", "urn:newsint.co.uk:Common:Proxy:SFTP", false, 1, 1, false, null, "sftpFault", SftpFault_Type.class, new SftpFault_Type(), new java.lang.String[][]{}, null, -1, -1, -1, -1, -1, -1, -1, -1, null);
    }
    ...
    public SftpFault_Type getSftpFault() {
        return (SftpFault_Type)baseTypeData().getElementValue(0);
    }
    ...
    public void setSftpFault(SftpFault_Type sftpFault) {
